...
public class ResultControler 
{
	...
	public String calculateData(int startStn, int endStn, int[] stnList)
	{
		...
		return printStation(count, 0, dataArr);
		//printStation(count, 0, dataArr); // 역 > 역 > 역 > 역
		//printData(0, count, dataArr); // 시간: 거리: 비용
	}
	...
	// 노선 출력
	public String printStation(int startIdx, int endIdx, int[][] dataArr)
	{
		String result = "";
